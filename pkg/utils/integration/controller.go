...
//	hasSnapshot := &appstudioshared.ApplicationSnapshot{}
	opts := []client.ListOption{
		client.InNamespace(namespace),
                client.MatchingFields{"spec.application": applicationName},

	}
	//	FieldSelector: fields.OneTermEqualSelector("spec.application", applicationName),
	...
	return &applicationSnapshots.Items[0], nil
//	return hasSnapshot, nil
}
...
func (h *SuiteController) GetIntegrationPipelineRun(integrationTestScenarioName string, applicationSnapshotName string, namespace string) (*tektonv1beta1.PipelineRun, error) {
	...
	//		"build.appstudio.openshift.io/component": "integration-suite-test-component-git-source-zniq",
		},
	}
